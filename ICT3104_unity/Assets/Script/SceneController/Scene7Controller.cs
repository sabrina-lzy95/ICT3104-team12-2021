...
public class Scene7Controller : MonoBehaviour
{
    ...
    private void SpawnCar(string carType)
    {
        ...
        {
            GameObject clonedCar = Instantiate(targetCar, new Vector3(146, 1, 5), Quaternion.Euler(0, 180, 0)); // Clone normal car at specified position and rotation.
        ...
        {
            GameObject clonedCar = Instantiate(targetCar, new Vector3(18, 1, -46), Quaternion.Euler(0, 0, 0)); // Clone normal car at specified position and rotation.
            CarEngine clonedCarScript = clonedCar.gameObject.GetComponent<CarEngine>(); // retrieves the script instance from the clone
